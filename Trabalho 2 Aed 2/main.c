/**
Descrição:Ele faz a leitura de um vetor ou uma lista encadeada
dentro da leitura de um vetor, pode ser feita a entrada de um arquivo
ou a geração de numero aleatorios para a ordenação.
Na lista encadeada ele pode ser feita a leitura de um arquivo ou geração
aleatoria, onde pode adicionar, remover, ou exibir a lista toda

Nota: Colocar o arquivo na pasta do programa com o nome "teste.txt"
Mudar o TAM para o tamanho desejado do colocquei com 20 para
testes igualmente a quantidade de numeros randomicos é limitado em 100
